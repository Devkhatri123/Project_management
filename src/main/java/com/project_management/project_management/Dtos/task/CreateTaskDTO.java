...
public record CreateTaskDTO(
        ...
        @NotNull(message = "Select a startDate") @JsonFormat(pattern = "dd-MM-yyyy hh:mm a", locale = "en_US") LocalDateTime startDate,
        @NotNull(message = "Select a startDate") @JsonFormat(pattern = "dd-MM-yyyy hh:mm a", locale = "en_US") LocalDateTime dueDate,
       ...
       // List<MultipartFile> task_attachments
        ) {
}
